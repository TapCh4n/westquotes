# [WestQuotes](https://xtapchan.github.io/westquotes/)

# 🇺🇸

WestQuotes is an Android app with Kanye West quotes.

### Features
- **Lots of Quotes**: Over 50 quotes.
- **Custom Widgets**: Highly customizable home screen widgets.
...
3. **Google Play Protect**: First select **Scan app**, then **Install**.
...
WestQuotes to aplikacja na Androida z cytatami Kanyego Westa.

### Funkcje
- **Dużo cytatów**: Ponad 50 cytatów.
- **Własne widżety**: Możliwość personalizacji widżetów na ekranie głównym.
- **Ulubione**: Opcja dodawania wybranych cytatów do listy ulubionych.
...
3. **Google Play Protect**: Najpierw wybierz **Skanuj aplikację**, a póżniej **Zainstaluj**.
...
- **Language**: Java
- **Security**: R8 Obfuscation enabled
